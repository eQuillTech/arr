...
class arr2 {
  ...
  public:
    ...
    // arr2sub<data_type>& operator()(const std::size_t iRow,const std::size_t iCol,const
    // std::size_t nRows,const std::size_t nCols);
    arr2sub<data_type> operator()(const std::size_t iRow,
                                  const std::size_t iCol,
                                  const std::size_t nRows,
                                  const std::size_t nCols);
    // arr2sub<data_type> operator()(const std::size_t iRow,const std::size_t iCol,const std::size_t
    // nRows,const std::size_t nCols) const;
