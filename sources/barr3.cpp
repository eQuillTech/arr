...
//static
barr3 barr3::zero(const size_t n0,const size_t n1,const size_t n2)
{
	barr3 res(n0,n1,n2);
	res=false;
	return res;
...
//static
barr3 barr3::ident(const size_t n0,const size_t n1,const size_t n2)
{
	barr3 A(n0,n1,n2);
	for(size_t i=0;i<n0;++i)
		for(size_t j=0;j<n1;++j)
			for(size_t k=0;j<n2;++k)
