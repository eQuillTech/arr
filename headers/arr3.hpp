...
public:
	arr3(const std::size_t n0=0,const std::size_t n1=0,const std::size_t n2=0,const data_type *a=NULL);
	...
	const std::size_t size() const{return m_n0*m_n1*m_n2;}
	...
	data_type& operator()(const std::size_t i,const std::size_t j,const std::size_t k){return at(i,j,k);}
	data_type const& operator()(const std::size_t i,const std::size_t j,const std::size_t k) const{return at(i,j,k);}
