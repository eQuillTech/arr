...
public:
	...
	barr2(const bool_arr2 &A):bool_arr2(A.size(0),A.size(1),A.source()){}
	...
	barr2sub operator()(const std::size_t iRow,const std::size_t iCol,const std::size_t nRows,const std::size_t nCols);
