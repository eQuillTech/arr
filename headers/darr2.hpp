...
public:
	darr2(const std::size_t nRows=0,std::size_t nCols=0,const double *a=NULL):double_arr2(nRows,nCols,a){}
	darr2(const darr1 &A):double_arr2(A){}
	darr2(const double_arr2 &A):double_arr2(A.size(0),A.size(1),A.source()){}
	...
	darr2sub sub(const std::size_t iRow,const std::size_t iCol,const std::size_t nRows,const std::size_t nCols);
	darr2sub operator()(const std::size_t iRow,const std::size_t iCol,const std::size_t nRows,const std::size_t nCols);
