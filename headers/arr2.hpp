...
public:
	...
	const std::size_t size() const{return m_nRows*m_nCols;}
	const std::size_t size(std::size_t d) const;
	...
	arr2sub<data_type> sub(const std::size_t iRow,const std::size_t iCol,const std::size_t nRows,const std::size_t nCols);
	...
	//arr2sub<data_type>& operator()(const std::size_t iRow,const std::size_t iCol,const std::size_t nRows,const std::size_t nCols);
	arr2sub<data_type> operator()(const std::size_t iRow,const std::size_t iCol,const std::size_t nRows,const std::size_t nCols);
	//arr2sub<data_type> operator()(const std::size_t iRow,const std::size_t iCol,const std::size_t nRows,const std::size_t nCols) const;
    ...
    iterator(data_type* p):ap(p){}
 		iterator operator++(){iterator i=*this;ap++;return i;}
		...
		iterator operator-(int n) const{return iterator(ap-n);}
		iterator& operator+=(int n){ap+=n;return *this;}
		iterator& operator-=(int n){ap-=n;return *this;}
